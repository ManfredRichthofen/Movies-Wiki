      ...
      <div className='grid grid-cols-2 gap-4 px-5 py-5'>
        ...
        <div className='flex justify-center items-center'>
          <Card variant='outlined' className='max-w-[400px]'>
            ...
            <p>
              An alternative to YouTube on android with built-in features like Ad blocking, SponsorBlock (Allows you to
              automatically skip in-video sponsors.), background play, Picture-in-picture, Amoled dark theme, and
              restore dislikes count.
            </p>
            <div className='flex justify-center items-center'>
              <a href={downloadURL}>
