...
- A [Jellyfin account](/docs/jellyfin/set-up-account/) (invite completed, username and password ready)
...
1. Enter your **Jellyfin username** and **password** (the ones from your [invite setup](/docs/jellyfin/set-up-account/)).
2. Tap **Sign In**.
3. Your library should load — browse movies and shows and tap one to play.

:::warning[Sign-in fails?]
Make sure you finished the invite link first. Until that is done, username/password login will not work. See [Set up your account](/docs/jellyfin/set-up-account/).
:::
...
Still stuck? See [Watch on any device](/docs/jellyfin/watch-anywhere/) or try the web player at [jfapp.xyz](https://jfapp.xyz).
