...
:::info
Need an account first? See [Set up your account](/docs/jellyfin/set-up-account/). Want something that is not in the library? See [Request movies & shows](/docs/jellyfin/request-titles/) — search in Jellyfin or Seerr and tap **Request**.
:::
...
For a step-by-step install and sign-in guide, see **[Watch on iPhone](/docs/jellyfin/watch-on-iphone/)**.
:::
